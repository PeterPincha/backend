      ...
      <div class="row">
        ...
        while ($reg = mysqli_fetch_array($datos)) {?>
          <div class="card col-sm-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="data:image/jpg;base64, <?php echo base64_encode($reg['foto'])?>" alt="" width="100px" height="100px")>
            <a href="ver.php?id=<?php echo $reg['idropa'];?>" class="card-body">
